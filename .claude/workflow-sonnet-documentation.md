# Workflow: Sonnet Documentation Consistency Check

## Agent: Sonnet Scribe

### Steps
1. Review all documentation (README, guides, specs, plans)
2. Ensure clarity, completeness, and cross-references
3. List missing or outdated docs
4. Document required updates

### Acceptance Criteria
- All docs are up-to-date and clear
- Missing/outdated docs are listed
